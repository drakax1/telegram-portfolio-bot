...
coins = {
    "ACA": {"id": "acala", "quantity": 1},
    "AR": {"id": "arweave", "quantity": 1},
    "AVAX": {"id": "avalanche-2", "quantity": 0},
    "BAND": {"id": "band-protocol", "quantity": 1},
    "CTK": {"id": "certik", "quantity": 1},
    "ETHFI": {"id": "ether-fi", "quantity": 0},
    "FET": {"id": "fetch-ai", "quantity": 1},
    "INJ": {"id": "injective-protocol", "quantity": 1},
    "NEAR": {"id": "near", "quantity": 1},
    "OCEAN": {"id": "ocean-protocol", "quantity": 1},
    "ONDO": {"id": "ondo-finance", "quantity": 1},
    "PENDLE": {"id": "pendle", "quantity": 1},
    "POL": {"id": "polygon-ecosystem-token", "quantity": 0},
    "RENDER": {"id": "render-token", "quantity": 1},
    "TIA": {"id": "celestia", "quantity": 1},
    "LINK": {"id": "chainlink", "quantity": 0},
}
